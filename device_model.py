...
class DeviceModel:
    ...
    def closeDevice(self):
        ...
        print("Device disconnected and stopped.")
    ...
    async def setOutputModeTo(self, value):
        ...
        print("Switched 0x96 register to output mode 2")
    ...
    async def setTransmissionRate(self, rate_value):
        ...
        print(f"Set transmission rate to {rate_value}")
    ...
    def writeDataToCSVPeriodically(self, filename, interval=2):
            ...
            with self.buffer_lock:
                if self.deviceDataBuffer:
                    with open(filename, mode='a', newline='') as file:
                        ...
                        print(f"Wrote {len(self.deviceDataBuffer)} records to {filename}")
